                ...
                <div class="top-header pt-2">
                        ...
                        <div class="col-sm-12">
                          <div class="form-group">
                            <label for="exampleFormControlTextarea1"
                              >Client Interface/experience design and
                              management</label
                            >
                            <textarea
                              class="form-control  white_input"
                  ...
                  <div class="row three_btn_margin">
                    <div class="col-sm-12">
                        ...
                        <button
                          type="button"
                          class="btn update_status_btn normal_btn text-white"
                        >
                          Save Only
                        </button>
                        <button
                          type="button"
                          class="btn normal_btn save_and_submit text-white"
                        >
                          Save and Submit
                        </button>
                        <button
                          type="button"
                          class="btn normal_btn cancel_modal_btn text-white"
                          data-toggle="modal"
