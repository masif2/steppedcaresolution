                                    ...
                                    <div class="row">
                                        <div class="col-xl-5 col-lg-6 col-md-6 col-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control white_input" id="newform" placeholder="" aria-describedby="newform">
                                            </div>
                                        </div>
                                        <div class="col-xl-3 col-lg-3 col-md-3 col-12">
                                            <label for="newform" class="form-label hide-on-mobile" style="visibility: hidden;display: block;">Create New Form</label>
                                            <button class="btn btn-primary table_btn mob_btn_margin">Save</button>
                                        </div>
                                    </div>
                                </form>
                                <div class="row">
