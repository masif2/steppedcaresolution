...
(function(X, L) {
    ...
    L(a, "Core/Utilities.js", [a["Core/Globals.js"]], function(a) {
        function v(b, d, g, r) {
            ...
            A(
                a,
                "displayError", { chart: g, code: b, message: M, params: r },
                function() {
                    if (d) throw Error(M);
    ...
    L(
        a,
        "Core/Chart/ChartDefaults.js", [a["Core/Color/Palette.js"]],
        function(a) {
            return {
    ...
    L(
        a,
        "Core/Color/Color.js", [a["Core/Globals.js"], a["Core/Utilities.js"]],
        function(a, u) {
            var v = u.isNumber,
                H = u.merge,
                x = u.pInt;
    ...
    L(
        a,
        "Core/Time.js", [a["Core/Globals.js"], a["Core/Utilities.js"]],
        function(a, u) {
            var v = a.win,
                H = u.defined,
                x = u.error,
    ...
    L(
        a,
        "Core/Animation/Fx.js", [a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Utilities.js"]],
        function(a, u, E) {
            var v = a.parse,
                x = u.win,
                y = E.isNumber,
    ...
    L(
        a,
        "Core/Animation/AnimationUtilities.js", [a["Core/Animation/Fx.js"], a["Core/Utilities.js"]],
        function(a, u) {
            function v(c) {
                return q(c) ?
    ...
    L(
        a,
        "Core/Renderer/HTML/AST.js", [a["Core/Globals.js"], a["Core/Utilities.js"]],
        function(a, u) {
            var v = a.SVG_NS,
                H = u.attr,
                x = u.createElement,
    ...
    L(
        a,
        "Core/FormatUtilities.js", [a["Core/DefaultOptions.js"], a["Core/Utilities.js"]],
        function(a, u) {
            function v(a, f, c, e) {
                a = +a || 0;
                f = +f;
                                ...
                                if (((A = A.join(":")), m.test(A))) {
                                    ...
                                    null !== e &&
                                        (e = c(
                                            e,
                                            p,
                                            n.decimalPoint, -1 < A.indexOf(",") ? n.thousandsSep : ""
                                        ));
        ...
        function(a, u, E, H, x, y) {
            ...
            a = (function() {
                ...
                a.prototype.applyTextOutline = function(b) {
                    ...
                    if ((g = g[0]) && "none" !== g && H.svg) {
                        ...
                        [].forEach.call(d.childNodes, function(b) {
                            var d = b.cloneNode(!0);
                            d.removeAttribute && ["fill", "stroke", "stroke-width", "stroke"].forEach(function(
                                b
                            ) {
                                ...
                                function(d, g) {
                                    ...
                                    r ||
                                        ((a = this[g + "Setter"] || this._defaultSetter),
                                            a.call(this, d, g, z), !this.styledMode &&
                                            this.shadows &&
                ...
                a.prototype.destroy = function() {
                    ...
                    b.safeRemoveChild(d);
                    for (
                        g.styledMode || b.destroyShadows(); c && c.div && 0 === c.div.childNodes.length;
                    ...
                    if (!f) {
                        ...
                        k.isSVG &&
                            ((d = f.width),
                                (k = f.height),
                                F &&
                                (f.height = k = { "11px,17": 14, "13px,20": 16 }[
    ...
    L(
        a,
        "Core/Renderer/RendererRegistry.js", [a["Core/Globals.js"]],
        function(a) {
            var v;
            (function(v) {
                var u;
    ...
    L(
        a,
        "Core/Renderer/SVG/SVGLabel.js", [a["Core/Renderer/SVG/SVGElement.js"], a["Core/Utilities.js"]],
        function(a, u) {
            var v =
                (this && this.__extends) ||
                (function() {
    ...
    L(a, "Core/Renderer/SVG/Symbols.js", [a["Core/Utilities.js"]], function(a) {
        function v(a, q, h, f, c) {
            ...
            if (c) {
                ...
                e.push(
                    ["M", a + m * l, q + h * J], ["A", m, h, 0, t, G(c.clockwise, 1), a + m * K, q + h * A]
                );
                x(f) &&
                    e.push(
        ...
        return {
            ...
            callout: function(a, q, h, f, c) {
                ...
                a + m >= h ?
                    ...
                    w.splice(
                        3,
                        1, ["L", a + h, c - 6], ["L", a + h + 6, c], ["L", a + h, c + 6], ["L", a + h, q + f - e]
                    ) :
                    w.splice(
                        3,
                        1, ["L", a + h, f / 2], ["L", m, c], ["L", a + h, f / 2], ["L", a + h, q + f - e]
                    ) :
                    0 >= a + m ?
                    c > q + t && c < q + f - t ?
                    w.splice(
                        7,
                        1, ["L", a, c + 6], ["L", a - 6, c], ["L", a, c - 6], ["L", a, q + e]
                    ) :
                    w.splice(
                        7,
                        1, ["L", a, f / 2], ["L", m, c], ["L", a, f / 2], ["L", a, q + e]
                    ) :
                    c && c > f && m > a + t && m < a + h - t ?
                    w.splice(
                        5,
                        1, ["L", m + 6, q + f], ["L", m, q + f + 6], ["L", m - 6, q + f], ["L", a + e, q + f]
                    ) :
                    c &&
                    0 > c &&
                    m > a + t &&
                    ...
                    w.splice(
                        1,
                        1, ["L", m - 6, q], ["L", m, q - 6], ["L", m + 6, q], ["L", h - e, q]
                    );
                return w;
            },
        ...
        function(a, u, E) {
            ...
            return (function() {
                ...
                h.prototype.modifyTree = function(a) {
                    ...
                    for (
                        a.forEach(e); a[0] && "tspan" === a[0].tagName && !a[0].children;
            ...
            E = (function() {
                ...
                z.prototype.button = function(b, d, g, k, c, z, l, e, f, F) {
                    ...
                    if (!Q) {
                        ...
                        delete l.style;
                        e = O(
                            h, { style: { color: H.neutralColor20 } },
                ...
                m.prototype.htmlUpdateTransform = function() {
                    if (this.added) {
                        ...
                        if ("SPAN" === c.tagName) {
                            ...
                            r !== this.cTT &&
                                ((F = a.fontMetrics(c.style.fontSize, c).b), !h(b) ||
                                ...
                                if (!d) {
                                    ...
                                    l.reverse().forEach(function(a) {
                                        ...
                                        B(a, {
                                            ...
                                            on: function() {
                                                l[0].div &&
                                                    h.on.apply({ element: l[0].div, onEvents: h.onEvents },
                                                        arguments
                                                    );
                                                return a;
                                            },
        ...
        function(a, u, E) {
            ...
            u = (function() {
                ...
                m.prototype.renderMark = function(a, c, e) {
                    ...
                    a = a.y;
                    var b = t(
                        f["minor" !== p ? "tickWidth" : "minorTickWidth"], !p && l.isXAxis ? 1 : 0
                    );
        ...
        function(a, u, E, H, x, y, G, B, q) {
            ...
            a = (function() {
                            ...
                            if (d.visible || !a.options.chart.ignoreHiddenSeries) {
                                ...
                                if (b.isXAxis) {
                                    ...
                                    ((d = d.applyExtremes()),
                                        ...
                                        ((z = d.dataMax),
                                            (b.dataMax = Math.max(C(b.dataMax, z), z))),
                                        l(r) && (b.threshold = r), !c.softThreshold || b.positiveValuesOnly)
                                )
                                    b.softThreshold = !1;
                            }
                        });
                    ...
                    D || a.isLinked ?
                        (e.forEach(function(b) {
                            ...
                            (a.reserveSpaceDefault =
                                0 === h ||
                                2 === h || { 1: "left", 3: "right" }[h] === a.labelAlign),
                            C(
                                n.reserveSpace,
                ...
                a.prototype.getTitlePosition = function() {
                    ...
                    a =
                        (b ? g + this.height : a) +
                        (b ? 1 : -1) * (r ? -1 : 1) * this.axisTitleMargin + [-F, F, D.f, -F][this.side];
                    b = {
                ...
                a.prototype.remove = function(b) {
                    for (
                        var a = this.chart, d = this.coll, g = this.series, c = g.length; c--;
    ...
    L(
        a,
        "Core/Axis/DateTimeAxis.js", [a["Core/Axis/Axis.js"], a["Core/Utilities.js"]],
        function(a, u) {
            var v = u.addEvent,
                H = u.getMagnitude,
                    ...
                    a.prototype.normalizeTimeTickInterval = function(a, h) {
                        ...
                        for (
                            ...
                            !((h = f[t]),
                                (c = y[h[0]]),
                                (e = h[1]),
                                f[t + 1] && a <= (c * e[e.length - 1] + y[f[t + 1][0]]) / 2); t++
                        );
    ...
    L(
        a,
        "Core/Axis/LogarithmicAxis.js", [a["Core/Axis/Axis.js"], a["Core/Utilities.js"]],
        function(a, u) {
            var v = u.addEvent,
                H = u.getMagnitude,
                x = u.normalizeTickInterval,
                    ...
                    if (e && l) {
                        ...
                        for (a = 0; a < e.length; a += 2) {
                            ...
                            (m && b[1] === c[1] ?
                                ...
                                h.push(
                                    ["M", c[1], c[2]], ["L", k[1], k[2]], ["L", g[1], g[2]], ["L", b[1], b[2]], ["Z"]
                                ));
                            h.isFlat = d;
                        }
                    }
        ...
        function(a, u, E, H, x) {
            ...
            a = (function() {
                ...
                a.prototype.init = function(a, c) {
                    ...
                    this.outside = l(
                        c.outside, !(!a.scrollablePixelsX && !a.scrollablePixelsY)
                    );
                };
                ...
                a.prototype.renderSplit = function(a, k) {
                    ...
                    a.forEach(function(b) {
                        ...
                        b = b.isHeader;
                        b ||
                            (d.outside && R + a < H && (H = R + a), !b && d.outside && H + g > ea && (ea = R + a));
                    });
                    a.forEach(function(b) {
                        var a = b.x,
                            g = b.anchorX,
        ...
        function(a, u, E, H, x) {
            ...
            a = (function() {
                ...
                a.prototype.setDOMEvents = function() {
                    ...
                    for (
                        var g = this.chart.renderTo.parentElement; g && "BODY" !== g.tagName;
                        ...
                        this.allItems.forEach(function(b) {
                            ...
                            if (g) {
                                ...
                                c(g, {
                                    ...
                                    top: k + "px",
                                    display: this.proximate || (k > f - 6 && k < f + d - 6) ?
                                        "" :
                                        "none",
                                });
                            }
                ...
                a.prototype.adjustMargins = function(a, d) {
                    ...
                    g && [
                        ...
                        f.test(g) &&
                            ...
                            (b[q[k]] = Math.max(
                                b[q[k]],
                                b.legend[(k + 1) % 2 ? "legendHeight" : "legendWidth"] + [1, -1, -1, 1][k] * c[k % 2 ? "x" : "y"] +
                                J(c.margin, 12) +
                                d[k] +
                                (b.titleOffset[k] || 0)
                            ));
                ...
                a.prototype.render = function() {
                    ...
                    0 < h &&
                        ...
                        (e[e.isNew ? "attr" : "animate"](
                                e.crisp.call({}, { x: 0, y: 0, width: h, height: m },
                                    e.strokeWidth()
                                )
                            ),
                            (e.isNew = !1));
        ...
        function(a, u, E, H, x, y, G, B, q, h, f, c, e, t, m) {
            ...
            a = (function() {
                ...
                a.prototype.applyDescription = function(a, b) {
                    ...
                    c = this.options[a] = U(!this.styledMode && { style: c },
                        this.options[a],
                        b
                    );
                    var e = this[a];
                ...
                a.prototype.setSize = function(a, b, d) {
                    ...
                    c.styledMode ||
                        (d ? w : O)(
                            c.container, { width: c.chartWidth + "px", height: c.chartHeight + "px" },
                            d
                        );
                    c.setChartSize(!0);
                    ...
                    b.styledMode ||
                        (O(g, z(c.style, { zIndex: 10 })),
                            ...
                            (O(g, { opacity: 0, display: "" }),
                                w(
                                    g, { opacity: c.style.opacity || 0.5 }, { duration: c.showDuration || 0 }
                                )));
                    b.loadingShown = !0;
                    e();
                };
                            ...
                            fa(a[b]).forEach(function(a, e) {
                                ...
                                !k &&
                                    ...
                                    (f.collectionsWithInit[b][0].apply(
                                        f, [a].concat(f.collectionsWithInit[b][1] || []).concat([!1])
                                    ).touched = !0);
                            });
                            d &&
    ...
    L(
        a,
        "Mixins/LegendSymbol.js", [a["Core/Globals.js"], a["Core/Utilities.js"]],
        function(a, u) {
            var v = u.merge,
                H = u.pick;
            ...
            a = (function() {
                ...
                a.prototype.updateData = function(a, d) {
                    ...
                    a.forEach(function(a, d) {
                        ...
                        if (l.id || S(m)) {
                            if (
                                ((m = this.findPointIndex(l, h)), -1 === m || "undefined" === typeof m ?
                                    f.push(a) :
                                    g[m] && a !== c.data[m] ?
                                    (g[m].update(a, !1, null, !1),
                                        (g[m].touched = !0),
                                        r && (h = m + 1)) :
                                    g[m] && (g[m].touched = !0), !p || d !== m || (e && e.enabled) || this.hasDerivedData)
                            )
                                k = !0;
                        } else f.push(a);
                    }, this);
                ...
                a.prototype.animate = function(a) {
                    ...
                    if (a) this.setClip(d);
                        ...
                        a && a.animate(e, d);
                        c &&
                            c.animate({ width: e.width + 99, x: e.x - (b.inverted ? 0 : 99) },
                                d
                            );
                    }
                };
                    ...
                    if (p && this.points) {
                        ...
                        this.points.forEach(function(a) {
                            a &&
                                a.series &&
                                (a.resolveColor(),
                                    Object.keys(w).length && a.destroyElements(w), !1 === A.showInLegend &&
                                    a.legendItem &&
                ...
                a.prototype.setState = function(a, b) {
                    ...
                    if (
                        ...
                        if (e && !e.dashstyle)
                            for (
                                f = { "stroke-width": k }, e.animate(f, h); d["zone-graph-" + c];
    ...
    L(
        a,
        "Core/Axis/StackingAxis.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Utilities.js"]],
        function(a, u) {
                    ...
                    if (this.options.stacking) {
                        ...
                        f.forEach(function(a, b) {
                            var r = 0,
                                ...
                                t;
                            if (u[a] && !u[a].isNull)
                                e.push(u[a]), [-1, 1].forEach(function(e) {
    ...
    L(
        a,
        "Series/Spline/SplineSeries.js", [a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]],
        function(a, u) {
            var v =
                (this && this.__extends) ||
                (function() {
                ...
                d.prototype.drawPoints = function() {
                    ...
                    a.points.forEach(function(b) {
                        ...
                        if (J(b.plotY) && null !== b.y) {
                            ...
                            d.styledMode ||
                                g[h](a.pointAttribs(b, b.selected && "select")).shadow(!1 !== b.allowShadow && c.shadow,
                                    null,
    ...
    L(
        a,
        "Mixins/CenteredSeries.js", [a["Core/Globals.js"], a["Core/Series/Series.js"], a["Core/Utilities.js"]],
        function(a, u, E) {
            var v = E.isNumber,
                x = E.pick,
                y = E.relativeLength,
        ...
        function(a, u, E) {
            ...
            E = (function(a) {
                ...
                c.prototype.getConnectorPath = function() {
                    ...
                    h[f] && (f = h[f]);
                    return f.call(
                        this, { x: a.final.x, y: a.final.y, alignment: a.alignment },
                        a.connectorPosition,
                        c
                    );
                };
                ...
                c.prototype.haloPath = function(a) {
                    ...
                    return this.sliced || !this.visible ?
                        ...
                        this.series.chart.renderer.symbols.arc(
                            ...
                            c.y,
                            c.r + a,
                            c.r + a, { innerR: c.r - 1, start: c.start, end: c.end }
                        );
                };
                ...
                c.prototype.setVisible = function(a, c) {
                    ...
                    a !== e.visible &&
                        ((e.visible =
                            ...
                            (f.options.data[f.data.indexOf(e)] = e.options), ["graphic", "dataLabel", "connector", "shadowGroup"].forEach(
                                function(c) {
                        ...
                        d.forEach(function(a) {
                            ...
                            b &&
                                ...
                                (b.attr({
                                    ...
                                    b.animate({ r: d.r, start: d.start, end: d.end },
                                        c.options.animation
                                    ));
                        });
                };
                        ...
                        a.targets.some(function() {
                            ...
                            if (
                                ...
                                return (
                                    ...
                                    h.reducedLen > 0.1 * c && E.distribute(h, c, e), !0
                                );
                            b += h[d].size;
                            d++;
                        })
                            ...
                            (d.forEach(function(a) {
                                ...
                                d.forEach(function(a) {
                                    a.dataLabel &&
                                        (a.visible ?
                                            (X[a.half].push(a),
                                                (a.dataLabel._pos = null), !c(f.style.width) &&
                                                !c(
    ...
    L(
        a,
        "Extensions/OverlappingDataLabels.js", [a["Core/Chart/Chart.js"], a["Core/Utilities.js"]],
        function(a, u) {
            function v(a, f) {
                var c = !1;
                if (a) {
                    ...
                    function c(a, f, h, m) {
                        ...
                        G(a, function(a, d) {
                            if (!m && -1 < e.collectionsWithUpdate.indexOf(d) && f[d])
                                for (
                                    a = q(a), h[d] = [], l = 0; l < Math.max(a.length, f[d].length); l++
                                )
                                    f[d][l] &&
                                    (void 0 === a[l] ?
                                        (h[d][l] = f[d][l]) :
